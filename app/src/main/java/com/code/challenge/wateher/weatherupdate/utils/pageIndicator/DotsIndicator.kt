package com.code.challenge.wateher.weatherupdate.utils.pageIndicator
...
class DotsIndicator @JvmOverloads constructor(
    ...
    override fun addDot(index: Int) {
        val dot = LayoutInflater.from(context).inflate(R.layout.indicator_layout, this, false)
        val imageView = with(dot) { findViewById<AppCompatImageView>(R.id.dot) }
